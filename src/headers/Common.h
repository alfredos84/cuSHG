/*---------------------------------------------------------------------------*/
// * This file contains a set of functions useful for checking CUDA errors,
// * timing the code and indexing vectors and matrices
/*---------------------------------------------------------------------------*/
...
// Function for indexing matrix in shared memory
__host__ __device__ inline int IDX_s(const int x, const int y, const int s_nx)
{
    return x + y*s_nx;
}
